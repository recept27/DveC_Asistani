        ...
        children: [
          ...
          SafeArea(
            child: AnimatedAlign(
              ...
              curve: _textCurve ?? Curves.elasticIn,
              alignment: Alignment(
                  _popButtonHorizontalAlignment, _popButtonVerticalAlignment),
          ...
          SafeArea(
            child: AnimatedAlign(
              ...
              curve: _textCurve ?? Curves.elasticIn,
              alignment: Alignment(
                  _nextButtonHorizontalAlignment, _nextButtonVerticalAlignment),
              child: GestureDetector(
                onTap: _showNext,
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text("İLERİ", style: AppTypography.extraBold24),
